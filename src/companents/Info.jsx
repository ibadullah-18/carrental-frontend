...
const Info = () => {
  const howItWorks = [
    {
      id: 1,
      title: "Maşınını əlavə et",
      description:
        "Hesabına daxil ol, maşının məlumatlarını, şəkillərini və digər detalları rahat şəkildə əlavə et.",
      icon: <PlusCircle size={20} strokeWidth={2.2} />,
    },
    {
      id: 2,
      title: "Paket seç və ödəniş et",
      description:
        "Maşının platformada görünməsi üçün uyğun paketi seç və təhlükəsiz şəkildə ödənişi tamamla.",
      icon: <CreditCard size={20} strokeWidth={2.2} />,
    },
    {
      id: 3,
      title: "Maşının platformada görünsün",
      description:
        "Elanın aktiv olduqdan sonra digər istifadəçilər maşınını platformada görə bilərlər.",
  ...
  const benefits = [
    {
      id: 1,
      title: "Rahat elan yerləşdirmə",
      description:
        "İstifadəçilər maşınlarını asanlıqla platformaya əlavə edib elanlarını idarə edə bilərlər.",
      icon: <ShieldCheck size={20} strokeWidth={2.2} />,
    },
    {
      id: 2,
      title: "Uyğun paket seçimləri",
      description:
        "Fərqli paketlərlə maşınını istədiyin müddət ərzində platformada göstərə bilərsən.",
      icon: <BadgeDollarSign size={20} strokeWidth={2.2} />,
    },
    {
      id: 3,
      title: "Bütün cihazlarda rahat istifadə",
      description:
        "Sayt telefon, planşet və kompüterdə sürətli və rahat işləyir.",
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center max-w-[760px] mx-auto mb-8 sm:mb-10 md:mb-14">
            ...
            <p className="text-[#6b6b6b] text-sm sm:text-base md:text-[15px] mt-3 leading-6">
              Platformada maşınını göstərmək çox sadədir. Məlumatları əlavə et,
              uyğun paketi seç və maşının digər istifadəçilərə görünsün.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 items-stretch">
              <div className="flex flex-col gap-4 sm:gap-5 justify-center order-2 lg:order-1">
                {howItWorks.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white border border-[#ececec] rounded-[22px] sm:rounded-[24px] px-4 sm:px-5 md:px-6 py-4 sm:py-5 shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)]"
                  >
              ...
              <div className="order-1 lg:order-2 flex justify-center">
                <div className="relative bg-[#fafafa] rounded-[32px] overflow-hidden p-6 w-fit flex items-center justify-center">
                  <div className="absolute top-0 right-0 w-[65%] h-[38%] bg-[#ededed] rounded-bl-[40px]" />

                  <div className="absolute bottom-0 left-0 w-[55%] h-[30%] bg-[#ededed] rounded-tr-[40px]" />
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center max-w-[820px] mx-auto mb-10 sm:mb-12 md:mb-14">
            ...
            <p className="text-[#b9b9b9] text-sm sm:text-base md:text-[15px] mt-3 leading-6">
              Məqsədimiz istifadəçilərə maşınlarını rahat şəkildə platformada
              göstərmək və digər istifadəçilərin bu maşınlara asanlıqla baxmasını
              təmin etməkdir.
            </p>
          </div>
